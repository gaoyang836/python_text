...
class c005002:
    def steps(self):
        ...
        self.ret1 = st.add_teacher('ke','ke','17800000000',
                                   '123456@qq.com','17500000000',
                                   '1',json.dumps(id))
        print(self.ret1)
        ...
        print('''\n\n***** step 3 **** 用新建账号登录   \n''')
        web.teacher_login('ke','888888')

        teacherText=web.get_teacher_homepage_info()
        print(teacherText)

        if teacherText != ['松勤学院01093', 'ke', '初中数学', '0', '0', '0']:
